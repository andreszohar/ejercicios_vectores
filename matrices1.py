# 1Realice un algoritmo que permita diseñar un sudoku, donde se debe de ingresar inicialmente la posición aleatoria de los valores con los cuales se va iniciar, luego deberá comenzar el juego y validar las jugadas, si excede el valor total por columnas o filas deberá emitir un mensaje de error.
